...
108 entries. Software-engineering laws, language rules, and cross-cutting craft guides. Leaves declare priority (1=foundational, 5=niche), applies_when (task contexts), and categories (list).

## Task territories (software engineering laws)

Engineering laws grouped by the kind of decision they inform.

- [[architecture]] — Laws governing system structure, coupling, service boundaries. (18 entries)
- [[design]] — Code patterns: DRY, KISS, YAGNI, SOLID, abstractions, coupling. (18 entries)
- [[teams]] — Organizational dynamics, communication, team sizing, coordination. (8 entries)
- [[planning]] — Estimation, timelines, optimization decisions, scoping. (14 entries)
- [[quality]] — Testing, technical debt, code health, resilience. (22 entries)
...
- [[languages]] — Per-language coding rules and style guides. (7 entries)

## Cross-cutting

Process and craft rules that apply regardless of language or layer.

- [[testing]] — Test writing principles and patterns. (8 entries)
- [[prs]] — Pull request workflow and review process. (2 entries)
